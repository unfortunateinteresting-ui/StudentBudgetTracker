...
const bootstrapFixture = {
  ...
  insight_snapshot: {
    ...
    this_month_spend: 0,
    this_month_cap: 0,
    this_month_capped_spend: 0,
    this_month_uncapped_spend: 0,
    this_month_cap_remaining: 0,
    spending_to_date: 0,
    average_monthly_spend: 0,
    planned_remaining_spending: 0,
    predicted_remaining_spending: 0,
    planned_total_spending: 0,
    predicted_total_spending: 0,
